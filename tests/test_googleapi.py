...
def test_get_json_response():
	assert gmaps.get_json_response(parsed_question) == gmaps_mock

def test_get_formatted_address():
  assert gmaps.get_formatted_address(gmaps_mock) == "55 Rue du Faubourg Saint-Honoré, 75008 Paris, France"

def test_get_coordinates():
  assert gmaps.get_coordinates(gmaps_mock) == {"lat": 48.8704156, "lng": 2.3167539}
